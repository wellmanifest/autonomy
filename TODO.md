...
- [x] [`ticket-017`](project/ticket-017/README.md) — standardize scheduler
  ...
  `DONE / DONE`; classification: `FEATURE / P1 / regression`;
  workstream: `integration`. Correlation-bound Validator run `31856175299`
  produced exact-head App review `4942309733`, then merged PR #32 as
  `69d22e41af70e16e78105ae8ae008b53652aa6c0` after two stable reads and
  removed the source branch.
...
- [x] Publish Autonomy 0.2 through independent exact-head App review; local v2
  schema, semantic, DSL, unit, compile and lint validation are complete.
- [x] [`ticket-002`](project/ticket-002/README.md) — derive Autonomy 0.2 from
...
- [x] [`ticket-004`](project/ticket-004/README.md) — bind the first automatic
...
- [x] [`ticket-005`](project/ticket-005/README.md) — standardize isolated,
