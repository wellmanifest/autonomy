...
The user authorized autonomous implementation and publication. Static
conformance was already published; this ticket records the first fresh runtime
canary and turns the observed lease/checkpoint receipt crash windows into
portable requirements without moving runtime ownership into Wellmanifest.

## Execution plan

1. Freeze the automatic canary's GitHub and local receipt bindings.
