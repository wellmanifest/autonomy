# Ticket 010: Align root documentation with Autonomy 0.5
...
published stable Autonomy 0.5 contract. Explain the new practice-backed change
control without changing normative, schema, profile, example, source or test
artifacts.
